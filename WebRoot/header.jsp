        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>CollegeInfo/frontlist">学院信息</a></li>
                <li><a href="<%=basePath %>SpecialFieldInfo/frontlist">专业信息</a></li>
                ...
                <li><a href="<%=basePath %>StudentSelectCourseInfo/frontlist">选课信息</a></li>
