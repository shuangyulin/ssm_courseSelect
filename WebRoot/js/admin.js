		       ...
		       text: "学院信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "CollegeInfo/collegeInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "学院信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CollegeInfo/collegeInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "专业信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SpecialFieldInfo/specialFieldInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "专业信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SpecialFieldInfo/specialFieldInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "班级信息管理",
		       ...
		       text: "选课信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "StudentSelectCourseInfo/studentSelectCourseInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "选课信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "StudentSelectCourseInfo/studentSelectCourseInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "成绩信息管理",
