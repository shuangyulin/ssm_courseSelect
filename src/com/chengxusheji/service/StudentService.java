...
public class StudentService {
    ...
    /*按照查询条件分页查询学生信息记录*/
    public ArrayList<Student> queryStudent(String studentNumber,String studentName,ClassInfo studentClassNumber,String studentBirthday,int currentPage) throws Exception { 
    	...
    	if(null != studentClassNumber &&  studentClassNumber.getClassNumber() != null  && !studentClassNumber.getClassNumber().equals(""))  where += " and t_student.studentClassNumber='" + studentClassNumber.getClassNumber() + "'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Student> queryStudent(String studentNumber,String studentName,ClassInfo studentClassNumber,String studentBirthday) throws Exception  { 
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(!studentName.equals("")) where = where + " and t_student.studentName like '%" + studentName + "%'";
    	if(null != studentClassNumber &&  studentClassNumber.getClassNumber() != null && !studentClassNumber.getClassNumber().equals(""))  where += " and t_student.studentClassNumber='" + studentClassNumber.getClassNumber() + "'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String studentNumber,String studentName,ClassInfo studentClassNumber,String studentBirthday) throws Exception {
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(!studentName.equals("")) where = where + " and t_student.studentName like '%" + studentName + "%'";
    	if(null != studentClassNumber &&  studentClassNumber.getClassNumber() != null && !studentClassNumber.getClassNumber().equals(""))  where += " and t_student.studentClassNumber='" + studentClassNumber.getClassNumber() + "'";
